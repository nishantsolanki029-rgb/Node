...
// });
// isuue:- every time you run file that put new data with exiting dat, so that print asme data every time you run the file
...
//     console.log("create a hello.txt")
// });
// isuue: when you change hello.txt file and after that you rn the file that cmd will be replace whole with above given data
...
//     console.log(files);
// });
// as a respose you get a array of and files name
...
// nest file name rename and move
...
// rename folder
// fs.rename('CSS/Home/Components', "CSS/Home/Components", (e)=>{
//     if(e) throw error;
...
console.log(chalk.bgYellow.bold("Write with Chalk"));